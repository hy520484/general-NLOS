...
# print(a.keys())
XY_real = si.loadmat('v_laser.mat')['XY_real2']	# unit: V, shape: (2, 4096), 0 for X, 1 for Y
...
si.savemat('transformation.mat', {'new_ori': new_ori, 'R': R})
...
si.savemat('laserpoints.mat', {'laserpoints': laserpoints})
