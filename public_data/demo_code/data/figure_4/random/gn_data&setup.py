...
C_d = si.loadmat('C_d.mat')['C_d']	# (200, 3)
...
laserpoints[C_i.shape[0]:, 2] = C_i[0, 0] * bz
detectpoints[C_i.shape[0]:, 0] = C_d[0, 1] * bx
detectpoints[C_i.shape[0]:, 1] = C_d[0, 2] * bx
detectpoints[C_i.shape[0]:, 2] = C_d[0, 0] * bz
...
sub_Sig = si.loadmat('sub_Sig.mat')['sub_Sig']	# (200, 1024)
print(sub_Sig.shape)
# sys.exit()
